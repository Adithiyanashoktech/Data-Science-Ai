...
def list_datasets():
    ...
    return [
        ...
        {"id": "RELIANCE.NS", "title": "Reliance Industries (NSE India)", "category": "Financials", "icon": "activity", "description": "Reliance Industries Limited stock performance on the National Stock Exchange of India."},
        {"id": "TCS.NS", "title": "Tata Consultancy Services (NSE India)", "category": "Financials", "icon": "trending-up", "description": "TCS equity prices and volumes tracking the IT service sector index in India."},
        {"id": "^NSEI", "title": "Nifty 50 Index (India)", "category": "Financials", "icon": "globe", "description": "Benchmark index representing the weighted average of 50 leading Indian companies."},
        {"id": "^BSESN", "title": "SENSEX Index (India)", "category": "Financials", "icon": "activity", "description": "Bombay Stock Exchange Sensitive Index tracking the 30 largest companies in India."},
